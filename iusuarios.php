  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      <a href="#" class="navbar-brand d-flex align-items-center">
        ...
        <strong>Catalogo de Conductores</strong>
      </a>
      <a href="principal.php" class="navbar-brand d-flex align-items-left">
...
<form method="POST" action="funciones/busquedac.php">
<div class="form-row">
    <div class="col">
      <input name="busquedaconductor" type="text" class="form-control" placeholder="Busqueda">
    </div>
